...
func newProduct(db *gorm.DB) product {
	...
	_product.ProductID = field.NewInt64(tableName, "product_id")
	_product.ProductName = field.NewString(tableName, "product_name")
	_product.Price = field.NewInt32(tableName, "price")
	_product.NumInventory = field.NewInt32(tableName, "num_inventory")
...
func (p *product) updateTableName(table string) *product {
	...
	p.NumInventory = field.NewInt32(table, "num_inventory")
...
func (p *product) fillFieldMap() {
	...
	p.fieldMap["num_inventory"] = p.NumInventory
}
