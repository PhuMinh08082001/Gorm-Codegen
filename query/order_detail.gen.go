...
func newOrderDetail(db *gorm.DB) orderDetail {
	_orderDetail := orderDetail{}

	_orderDetail.orderDetailDo.UseDB(db)
	_orderDetail.orderDetailDo.UseModel(&model.OrderDetail{})

	tableName := _orderDetail.orderDetailDo.TableName()
	_orderDetail.ALL = field.NewField(tableName, "*")
	_orderDetail.OrderID = field.NewInt64(tableName, "order_id")
	_orderDetail.ProductID = field.NewInt64(tableName, "product_id")
...
func (o orderDetailDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) *orderDetailDo {
